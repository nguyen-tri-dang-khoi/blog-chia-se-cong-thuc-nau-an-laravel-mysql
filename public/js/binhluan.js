$(function(){
    $('#btn-gui-binh-luan').click(function(e){
      let _token = $('meta[name="csrf-token"]').attr('content');
      e.preventDefault();
      let noi_dung_binh_luan = $('textarea[name=comment]').val();
      let cong_thuc_id = $('#post').attr('data-id');
      let url = window.location.protocol + "//" +window.location.hostname + ":" + window.location.port  + "/binhluans";
      $.ajax({
        url: url,
        type: "POST",
        data:{
